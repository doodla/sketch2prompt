import { Monitor, Server, Database, ShieldCheck, Cloud, Cog, Brain } from 'lucide-react'
...
export const NODE_OPTIONS: NodeOption[] = [
  ...
  { type: 'mindmap', label: 'Mind Map', icon: Brain, shortcut: '7', description: 'AI-assisted mind map node' },
]
